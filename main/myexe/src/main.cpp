...
/*vérifie s'il il y a un contact réel entre deux primitives, si c'est le cas, on rajoute le contact
 * dans data*/
void generateContact(Primitive p_prim1, Primitive p_prim2, CollisionData& p_data)  //ne fonctionne pas c'est pour cela que nous avons traité la collision avec un cas plus particulier
{
...
/*vérifie s'il il y a un contact réel entre un plan et une box, si c'est le cas, on rajoute le
 * contact dans data*/
